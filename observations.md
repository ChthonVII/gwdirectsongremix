...
- Explorables/Missions
    ...
    - All other explorables/missions
        ...
        - Tihark Orchard mission seems heavily biased towards `outhigc`. (Unlike other explorables/missions, vanilla behavior for `outhigc` in this mission is "The Makers' Song".) 
- No-DirectSong/`*` behavior is:
